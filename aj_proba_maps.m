...
% Function to create the tissue probability maps based on the anatomical
% phantom
%
% INPUT
% anat_phantom:     3D matrix containing the anatomical phantom
% param:            Structure containing the defaut parameters
% flag:             Structure containing the default flags
%
% OUTPUT
% proba_map:        Tissue probability maps
%
%--------------------------------------------------------------------------
